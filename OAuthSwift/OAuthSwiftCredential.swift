...
public protocol OAuthSwiftCredentialHeadersFactory {
    func make(_ url:URL, method: String, parameters: Dictionary<String, AnyObject>, body: Data?) -> Dictionary<String, String>
}
...
open class OAuthSwiftCredential: NSObject, NSCoding {
    ...
    // MARK: functions
    open func makeHeaders(_ url:URL, method: String, parameters: Dictionary<String, AnyObject>, body: Data? = nil) -> Dictionary<String, String> {
    ...
    open func authorizationHeaderForMethod(_ method: String, url: URL, parameters: Dictionary<String, Any>, body: Data? = nil) -> String {
    ...
    open func authorizationHeaderForMethod(_ method: String, url: URL, parameters: Dictionary<String, Any>, body: Data? = nil, timestamp: String, nonce: String) -> String {
    ...
    open func authorizationParametersWithSignatureForMethod(_ method: String, url: URL, parameters: Dictionary<String, Any>, body: Data? = nil) -> Dictionary<String, Any> {
        let timestamp = String(Int64(Date().timeIntervalSince1970))
        let nonce = OAuthSwiftCredential.generateNonce()
    ...
    open func authorizationParametersWithSignatureForMethod(_ method: String, url: URL, parameters: Dictionary<String, Any>, body: Data? = nil, timestamp: String, nonce: String) -> Dictionary<String, Any> {
    ...
    open func authorizationParameters(_ body: Data?, timestamp: String, nonce: String) -> Dictionary<String, Any> {
    ...
    open func signatureForMethod(_ method: String, url: URL, parameters: Dictionary<String, Any>) -> String {
        var tokenSecret = ""
